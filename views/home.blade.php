                                ...
                                <div class="row">
                                    <div class="col-xl-7">
                                        <div class="at-hero-title">
                                            <span class="at-subtitle text-primary position-relative fw-bold">Wypoyczalnia samochodów</span>
                                            <h1 class="text-white mb-4 mt-3 display-4">Marcediz Benz - 2.0</h1>
                                            <p class="mb-30">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras consectetur rhoncus nisl eget scelerisque. Phasellus non dignissim diam. </p>
                                            <ul class="car-info mt-3 mb-30 fs-md fw-500">
                                                <li class="pt-1"><span class="me-2"><i class="fa-regular fa-circle-check"></i></span>Skurzane fotele</li>
                                                <li class="pt-1"><span class="me-2"><i class="fa-regular fa-circle-check"></i></span>Szyberdach</li>
                                                <li class="pt-1"><span class="me-2"><i class="fa-regular fa-circle-check"></i></span>Podgrzewane siedzenia</li>
                                            </ul>
                                            <a href="index.html" class="at-explore-btn"><span class="me-2">
                ...
                <div class="col-lg-12">
                    <div class="at-search-box-filter bg-white">
                        <ul class="nav nav-tabs border-0 justify-content-center justify-content-sm-start">
                            <li><a href="#all_status" data-bs-toggle="tab" class="active">Wyszukaj swój wymarzony samochód</a></li>
                        </ul>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <div class="at-section-title text-center">
                        <span class="at-subtitle lead text-primary position-relative">Przeglądaj topowe marki</span>
                        <h2 class="mt-1 mb-0 h1">Marki z typami nadwozia</h2>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-12">
                    <div class="at-section-title text-center text-lg-start">
                        <span class="at-subtitle position-relative lead text-primary">Nowo dodane zgłoszenia</span>
                        <h2 class="h1 mt-2 mb-0">Znajdź najlepszą ofertę dla siebie</h2>
                    </div>
                </div>
            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-7 col-lg-8">
                        <div class="at-section-title text-center">
                            ...
                            <h2 class="h1 mb-0 mt-2">Najczęściej zadawane pytania</h2>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-xl-10">
                        <div class="faq-tabs mt-5 brands-filter">
                            <ul class="nav nav-tabs border-0 justify-content-center">
                                <li><a href="#general" data-bs-toggle="tab" class="active"><span class="me-2"><i class="fa-solid fa-users"></i></span>Pytania ogólne</a></li>
                                <li><a href="#features" data-bs-toggle="tab"><span class="me-2"><i class="fa-solid fa-car-side"></i></span>Cechy samochodów</a></li>
