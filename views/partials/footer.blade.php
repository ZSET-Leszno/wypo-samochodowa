                ...
                <div class="row align-items-center">
                    <div class="col-sm-7">
                        <div class="copyright-text">
                            <p class="mb-0">&copy; Wszelkie prawa zastrzeżone. Wykonane przez: <a href="https://michus.studio" target="_blank">Michał Marciniak</a> && <a href="https://pietrasz.studio" target="_blank">Igor Pietrasz</a></p>
                        </div>
                    </div>
                    <div class="col-sm-5">
                        <div class="copyright-links text-start text-sm-end mt-1 mt-sm-0">
                            <a href="{{$config->base_url}}regulamin.pdf" target="_blank">Regulamin</a>
                            <a href="{{$config->base_url}}polityka-prywatnosci.pdf" target="_blank">Polityka prywatności</a>
                        </div>
                    </div>
                </div>
            </div>
...
<!--build:js-->
<script>const baseUrl = '{{ $config->base_url }}';</script>
